...
- **Onboarding**: `OnboardingFlow.jsx` ya cubría el wizard de 6 pasos completo (welcome con elección Lite/Pro fusionada + about/situation/goals/jars/done) — se agregaron los badges de gamificación (🌱 Semilla <40% / 🌿 Brote 40-74% / 🌳 Árbol ≥75%) en el paso final, que faltaban por completo (solo había un checkmark genérico).
