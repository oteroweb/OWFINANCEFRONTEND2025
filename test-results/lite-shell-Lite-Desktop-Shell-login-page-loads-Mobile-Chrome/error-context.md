...
- Name: lite-shell.spec.ts >> Lite Desktop Shell >> login page loads
- Location: e2e/lite-shell.spec.ts:14:3
...
- Iniciar sesión
+
+      v1.0.22404Oops. Nothing here...Go Home
+   
+
+
...
Call log:
  ...
  - waiting for locator('body')
    14 × locator resolved to <body class="mobile touch platform-android body--light">…</body>
       - unexpected value "
     v1.0.22404Oops. Nothing here...Go Home
...
```yaml
- text: v1.0.22 404 Oops. Nothing here...
- link "Go Home":
  - /url: /
```
