...
- Name: debug-real-user.spec.ts >> Real user navigation debug >> Full flow: load landing → click Planes → check what happens
- Location: e2e/debug-real-user.spec.ts:6:3
...
Call log:
  - waiting for locator('a:has-text("Planes")')
