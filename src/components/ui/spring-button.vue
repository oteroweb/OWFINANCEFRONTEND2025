<template>
  <component
    :is="tag"
    class="relative inline-flex items-center justify-center overflow-hidden font-medium transition-all duration-200 active:scale-[0.97]"
    :class="[
      ...
      size === 'lg' ? 'px-6 py-3 text-lg rounded-2xl' : '',
      block ? 'w-full' : ''
    ]"
